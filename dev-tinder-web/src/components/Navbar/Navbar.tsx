          ...
          {user?.name ? (
            <>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/requests" className="block text-white py-2">
                    Requests
                  </Link>
                </li>
                <li>
                  <Link href="/connections" className="block text-white py-2">
                    Connections
                  </Link>
                </li>
                <li onClick={handleLogout}>
                  <span className="block text-white py-2 cursor-pointer">
                    Logout
                  </span>
                </li>
              </ul>
